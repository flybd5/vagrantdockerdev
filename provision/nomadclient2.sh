...
[Service]
ExecStart=/usr/local/bin/nomad agent -client -config=/etc/nomad.d/nomadclient.hcl -data-dir=/var/lib/docker/data/nomad/client -servers=[192.168.50.11:4647] 
