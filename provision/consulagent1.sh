...
[Service]
ExecStart=/usr/local/bin/consul agent -server -data-dir="/var/lib/docker/data/consul" -encrypt="bDhos7P0U+P4Vy3PrB0QNA==" -node=node2 -bind=192.168.50.12 -client=192.168.50.12 -retry-join "192.168.50.11"
